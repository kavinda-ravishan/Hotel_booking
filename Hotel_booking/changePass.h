...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(36, 127);
			...
			this->label1->Text = L"New User name";
			// 
			// label2
			// 
			this->label2->AutoSize = true;
			this->label2->Location = System::Drawing::Point(27, 64);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(142, 127);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(75, 23);
			this->button2->TabIndex = 4;
			this->button2->Text = L"Cancel";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &changePass::button2_Click);
			// 
			// textBox3
			// 
...
#pragma endregion
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		String ^ Path = "data/pass.txt";
		if (textBox2->Text == textBox3->Text) {
			StreamWriter ^ pass = gcnew StreamWriter(Path);

			pass->WriteLine(textBox1->Text);
			pass->WriteLine(textBox2->Text);
			pass->Close();
			this->Close();
			MessageBox::Show("User Name and Password updated", "Note");
		}
		else MessageBox::Show("Passwords dismatch", "Fail");
	}
